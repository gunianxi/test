 ...
 * 功能描述 TODO
 *
 * @author nianxi on 2021/7/23 21:53
 */
public class Debug {
    public static void main(String[] args){
        Scanner sc=new Scanner(System.in);
        System.out.println("请输入星期天：");
        int week=sc.nextInt();
/**
        if(week<1||week>7){
 ...
 */
     switch (week){
         ...
         case 4:System.out.println("单车");break;
         case 5:System.out.println("拳击");break;
         case 6:System.out.println("爬山");break;
         case 7:System.out.println("吃");break;
         default:System.out.println("输入星期错误！");
     }
    }
}
